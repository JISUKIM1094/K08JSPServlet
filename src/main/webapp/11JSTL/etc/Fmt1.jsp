...
<body>
	...
	소수점까지 : <fmt:parseNumber value="${'6,789.01'}" pattern="00,000.00" /><br>
	
	<fmt:parseNumber value="${number2 }" pattern="0,0.0" var="printNum3"/>
	소수점까지 : ${printNum3 }<br>
	<fmt:parseNumber value="${number2 }" pattern="00000000,00000000.000000000" var="printNum3"/>
	소수점까지 : ${printNum3 }<br>
	<%-- 숫자가 존재하는 자리에 0없으면 에러발생
	<fmt:parseNumber value="${number2 }" pattern=",.0" var="printNum3"/>
	소수점까지 : ${printNum3 }<br>	 
	--%>
